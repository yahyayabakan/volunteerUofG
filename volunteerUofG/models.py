...
class Charity(models.Model):
    ...
    image = models.ImageField(upload_to= 'profile_images', null=True, blank=True, default='https://m.media-amazon.com/images/I/4193V9-69jS._AC_SY780_.jpg')    #profile_picture = models.ImageField(null=True, blank=True)
    def __str__(self):
    	return self.user.username
...
class Opportunity(models.Model):
    ...
    image = models.ImageField(upload_to= 'profile_images', null=True, blank=True,default='https://www.covenantgroup.com/img/84')    
    def __str__(self):
        return self.title
